package org.example.patient_service.controller;
...
import org.example.patient_service.service.PatientService;
...
@Tag(name = "Patient", description = "API for managing Patients") // http://localhost:4000/v3/api-docs - for swagger
